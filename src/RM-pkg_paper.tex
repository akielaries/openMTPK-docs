...
\begin{flushleft}
\justify{
RM-pkg is a reusable mathematics library written in C++ originally inspired from 
...
github repository: \url{https://github.com/akielaries/RM-pkg}
...
The goal of RM-pkg is to have as little dependencies as possible without re-inventing the
